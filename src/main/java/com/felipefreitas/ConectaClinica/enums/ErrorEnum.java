...
public enum ErrorEnum {
    ...
    // 0-99: Erros Gerais, Entrada e Autenticação/Autorização (400, 401, 403, 500)
    ...
    TIPO_EXAME_NAO_ENCONTRADO(404, 402, "Tipo de exame não encontrado"),
    TIPO_EXAME_JA_CADASTRADO(409, 403, "Já existe um tipo de exame cadastrado com este nome"),
